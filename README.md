...
- 新增本地 LRC 自动搜索，歌名与歌手匹配时优先于缓存和在线歌词
- 新增标准 LRC、增强型 LRC 和逐字时间轴的统一卡拉 OK 动效
- 优化元数据清洗、歌手匹配、专辑排序与封面一致性校验
- 优化曲库排序栏的沉浸式背景表现
- 优化曲库搜索、拼音排序、歌词时间轴、封面下载和本地歌词扫描性能

### v1.0.0（2026-07-24）

- 首个正式发布版本
- 提供本地音乐播放、歌词、元数据编辑与 ReadAlong 同步阅读

...
class SettingsViewModelTest {
    ...
    private val mediaUsageRepository: MediaUsageRepository = mockk(relaxed = true)
    ...
    fun setup() {
        ...
        every { mediaUsageRepository.observeMusicStats() } returns kotlinx.coroutines.flow.flowOf(luzzr.muse.domain.model.MusicUsageStats())

...
/**
 * Implementation of [AudioFileHealthCheckUseCase] that uses [TagEditor] to validate audio files.
 */
@Singleton
class AudioFileHealthCheckUseCaseImpl @Inject constructor(
    private val tagEditor: TagEditor
) : AudioFileHealthCheckUseCase {

    override suspend fun invoke(songs: List<Song>, onProgress: suspend (AudioHealthProgress) -> Unit): AudioHealthProgress =

...
interface MediaUsageDao {
    ...
    suspend fun addListened(mediaType: String, mediaId: String, dayStart: Long, durationMs: Long, atMs: Long): Int
    ...
    suspend fun addRead(mediaType: String, mediaId: String, dayStart: Long, durationMs: Long, atMs: Long): Int

...
object MotionList {
    val fadeIn = tween<Float>(MotionDuration.medium1, easing = MotionEasing.standard)
    val fadeOut = tween<Float>(MotionDuration.short, easing = MotionEasing.accelerate)
    val placement = spring<IntOffset>(
...
object MotionReader {
    val chromeEnter = slideInVertically(
        ...
        animationSpec = tween(MotionDuration.medium1, easing = MotionEasing.emphasizedDecelerate)
    ) + fadeIn(animationSpec = tween(MotionDuration.medium1, easing = MotionEasing.standard))
    val chromeExit = slideOutVertically(
        targetOffsetY = { height -> -height / 3 },
        animationSpec = tween(MotionDuration.short, easing = MotionEasing.accelerate)
    ) + fadeOut(animationSpec = tween(MotionDuration.short, easing = MotionEasing.accelerate))
    val controlsEnter = slideInVertically(
        initialOffsetY = { height -> height / 3 },
        animationSpec = tween(MotionDuration.medium1, easing = MotionEasing.emphasizedDecelerate)
    ) + fadeIn(animationSpec = tween(MotionDuration.medium1, easing = MotionEasing.standard))
    val controlsExit = slideOutVertically(
        targetOffsetY = { height -> height / 3 },
        animationSpec = tween(MotionDuration.short, easing = MotionEasing.accelerate)
    ) + fadeOut(animationSpec = tween(MotionDuration.short, easing = MotionEasing.accelerate))
}
...
object MotionSheet {
    val contentEnter = fadeIn(
        animationSpec = tween(MotionDuration.medium1, easing = MotionEasing.standard)
    )
    val contentExit = fadeOut(
        animationSpec = tween(MotionDuration.short, easing = MotionEasing.accelerate)
    )
}
